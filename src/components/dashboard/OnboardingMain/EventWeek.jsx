            ...
            <div className="events">
              ...
              <div className="mainContainer max-h-[250px] overflow-y-auto pr-2 custom-scrollbar">
                ...
                <div className="mainContainer flex gap-[16px] border-b-[1px] border-b-[#ABABAB] mb-[20px] pb-[14px] pr-[18px]">
                  ...
                  {/* col2 */}
                  <div className="pl-[50px] mt-[10px] flex flex-col items-end text-[14px] text-[#ABABAB]">
                    <div className="flex items-center gap-1 mb-2">
                      <p className="ticketSold font-semibold text-[#ABABAB]">{ticketSold}</p>
                      <span>/</span>
                ...
                <div className="mainContainer flex gap-[16px] border-b-[1px] border-b-[#ABABAB] mb-[20px] pb-[14px] pr-[18px]">
                  ...
                  <div className="pl-[50px] mt-[10px] flex flex-col items-end text-[14px] text-[#ABABAB]">
                    <div className="flex items-center gap-1 mb-2">
                      <p className="ticketSold font-semibold text-[#ABABAB]">{ticketSold2}</p>
                      <span>/</span>
                      <p className="ticketMaximum text-[#aaa]">{ticketMaximum2}</p>
                    </div>
                    <div className="w-[100px] h-[8px] bg-gray-300 rounded-full overflow-hidden">
                      <div
                        className="h-full transition-all duration-300 rounded-full"
                ...
                <div className="mainContainer flex gap-[16px] border-b-[1px] border-b-[#ABABAB] mb-[20px] pb-[14px] pr-[18px]">
                  ...
                  <div className="pl-[50px] mt-[10px] flex flex-col items-end text-[14px] text-[#ABABAB]">
                    <div className="flex items-center gap-1 mb-2">
                      <p className="ticketSold font-semibold text-[#ABABAB]">{ticketSold3}</p>
                      <span>/</span>
                      <p className="ticketMaximum text-[#aaa]">{ticketMaximum3}</p>
                    </div>
                    <div className="w-[100px] h-[8px] bg-gray-300 rounded-full overflow-hidden">
                      <div
                        className="h-full transition-all duration-300 rounded-full"
